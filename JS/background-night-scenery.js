...
var Clock = (function() {
    var canvas,
        ...
        press = false, 
        quiver = true, 
        texts = [":3","FELIZ", "CUMPLEAÑOS", "MELLY", "ERES", "LA", "MEJOR", "TE QUIERO" , "MUCHO", "LICENCIADA", "ATTE:", "RED"],
        text = texts[0],
        textNum = 0,
        textSize = 60, 
        valentine = false, 
...
if (textNum >= texts.length) {
    setTimeout(() => {
        window.location.href = "Paginas/menu.html"; // Cambia por la URL de destino
    }, 2000); // Espera 2 segundos antes de redirigir (opcional)
} else {
    text = texts[textNum];
}; 
